	...
	)
{
    ...
    PIO_STACK_LOCATION     irpStack  = IoGetCurrentIrpStackLocation(Irp);//получени€ указател€ на стек IRP пакета используетс€ функци€:
    ...
    switch(irpStack->Parameters.DeviceIoControl.IoControlCode)//получение управл€ющего IOCTL кода;
    {
